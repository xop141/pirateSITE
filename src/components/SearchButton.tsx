...
const SearchButton = () => {
 ...
 const router = useRouter();
  ...
  return (
    ...
    <div className={`w-[60%] flex items-center rounded-[8px] border px-[12px] `}>
      <Search />
      <Input
        type="text"
    ...
    <div className="mt-4  flex justify-center flex-col ">
      <ul className='bg-background border rounded-[8px] p-[10px] '>
        {popular.slice(0,3).map((movie) => (
          ...
          <div className='text-black font-[600]' onClick={()=>seeMore(searchVALUE)}>see all results for "{searchVALUE}" </div>
      </ul>
